...
const Chat = () => {
  ...
  return (
    <div className="fixed bottom-32 left-5">
      {openChat?
        <div className=" w-[75%] ">
        <div className="w-full bg-blue-700 rounded-t-lg">
          <div className="flex justify-between w-[90%] py-2 m-auto  text-white">
            ...
            <div>
              <h1 className='font-semibold text-[14px] sm:text-[16px]'>Start a Conversation</h1>
              <p className='sm:text-[12px] text-[10px] font-semibold'>Hi! Click one of our member below to chat on WhatsApp</p>
            </div>
          </div>
        </div>
        <div className="w-full bg-white rounded-b-lg py-3 pb-7">
          <div className="w-[90%]  m-auto">
            <h1 className='text-xs text-gray-500 pb-3' >The team typically replies in a few minutes.</h1>
            <div className="flex justify-around rounded hover:shadow-lg bg-gray-200 hover:bg-white cursor-pointer border-l-2 py-2 border-green-700">
      ...
      <div className='bg-gray-200 px-2 py-1 rounded ml-[70px] -mb-10'>
      ...
      {openChat === false ? (
        <div
          onClick={toggle}
          className="h-16 cursor-pointer w-16 text-center flex items-center rounded-full bg-blue-800"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
